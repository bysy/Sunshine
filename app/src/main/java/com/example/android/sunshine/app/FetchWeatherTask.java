...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    FetchWeatherTask(Context context, ArrayAdapter<String> adapter) {
        mContext = context;
        mAdapter = adapter;
        SharedPreferences settings = PreferenceManager.
                getDefaultSharedPreferences(mContext);
        final String unitsKey = mContext.getString(R.string.prefs_units_key);
    ...
    // NOTE: Warnings suppressed since code supplied from gist
    ...
    private String formatHighLows(double high, double low) {
        if (UNITS.equals(mContext.getString(R.string.pref_value_imperial))) {
